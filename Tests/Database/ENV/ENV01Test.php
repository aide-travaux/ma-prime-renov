...
use AideTravaux\MaPrimeRenov\Database\ENV\ENV01;
...
class ENV01Test extends TestCase
{
    ...
    public function testMethods($model)
    {
        ...
        $this->assertTrue(\is_float(ENV01::getMontant($stub)));
        $this->assertTrue(\is_float(ENV01::getPlafond($stub)));
        $this->assertTrue(\is_int(ENV01::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_int(ENV01::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_array(ENV01::toArray($stub)));
    }
