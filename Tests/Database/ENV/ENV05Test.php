...
use AideTravaux\MaPrimeRenov\Database\ENV\ENV05;
...
class ENV05Test extends TestCase
{
    ...
    public function testMethods($model)
    {
        ...
        $this->assertTrue(\is_float(ENV05::getMontant($stub)));
        $this->assertTrue(\is_float(ENV05::getPlafond($stub)));
        $this->assertTrue(\is_int(ENV05::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_int(ENV05::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_array(ENV05::toArray($stub)));
    }
