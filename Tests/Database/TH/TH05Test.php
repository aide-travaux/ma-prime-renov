...
use AideTravaux\MaPrimeRenov\Database\TH\TH05;
...
class TH05Test extends TestCase
{
    ...
    public function testGetMontant($model, $expect)
    {
        ...
        $this->assertEquals(TH05::getMontant($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH05::getPlafond($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH05::getPlafondForfaitaire($stub), $expect);
    }
