...
use AideTravaux\MaPrimeRenov\Database\TH\TH06;
...
class TH06Test extends TestCase
{
    ...
    public function testGetMontant($model, $expect)
    {
        ...
        $this->assertEquals(TH06::getMontant($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH06::getPlafond($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH06::getPlafondForfaitaire($stub), $expect);
    }
