...
use AideTravaux\MaPrimeRenov\Database\TH\TH08;
...
class TH08Test extends TestCase
{
    ...
    public function testGetMontant($model, $expect)
    {
        ...
        $this->assertEquals(TH08::getMontant($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH08::getPlafond($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH08::getPlafondForfaitaire($stub), $expect);
    }
