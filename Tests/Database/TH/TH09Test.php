...
use AideTravaux\MaPrimeRenov\Database\TH\TH09;
...
class TH09Test extends TestCase
{
    ...
    public function testGetMontant($model, $expect)
    {
        ...
        $this->assertEquals(TH09::getMontant($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH09::getPlafond($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH09::getPlafondForfaitaire($stub), $expect);
    }
