...
use AideTravaux\MaPrimeRenov\Database\TH\TH12;
...
class TH12Test extends TestCase
{
    ...
    public function testGetMontant($model, $expect)
    {
        ...
        $this->assertEquals(TH12::getMontant($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH12::getPlafond($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH12::getPlafondForfaitaire($stub), $expect);
    }
