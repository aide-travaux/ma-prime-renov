...
use AideTravaux\MaPrimeRenov\Database\TH\TH14;
use AideTravaux\MaPrimeRenov\Model\DataInterface;

class TH14Test extends TestCase
{
    ...
    public function testMethods($model)
    {
        ...
        $this->assertTrue(\is_float(TH14::getMontant($stub)));
        $this->assertTrue(\is_float(TH14::getPlafond($stub)));
        $this->assertTrue(\is_int(TH14::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_int(TH14::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_array(TH14::toArray($stub)));
    }
