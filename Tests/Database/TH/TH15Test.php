...
class TH15Test extends TestCase
{
    ...
    public function testMethods($model)
    {
        ...
        $this->assertTrue(\is_float(TH15::getMontant($stub)));
        $this->assertTrue(\is_float(TH15::getPlafond($stub)));
        $this->assertTrue(\is_int(TH15::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_int(TH15::getMontantForfaitaire($stub)));
        $this->assertTrue(\is_array(TH15::toArray($stub)));
    }
