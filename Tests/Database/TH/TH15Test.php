...
use AideTravaux\MaPrimeRenov\Database\TH\TH15;
use AideTravaux\MaPrimeRenov\Model\DataInterface;

class TH15Test extends TestCase
{
    /**
    ...
    public function testGetMontant($model, $expect)
    {
        ...
        $this->assertEquals(TH15::getMontant($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH15::getMontantForfaitaire($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH15::getPlafond($stub), $expect);
    }
    ...
    {
        $stub = $this->getMock($model);
        $this->assertEquals(TH15::getPlafondForfaitaire($stub), $expect);
    }
